...
{
    wp_enqueue_style('slider-swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css');
...
function concordia_scripts()
{
    ...
    wp_enqueue_script('slider-swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), null, true);
